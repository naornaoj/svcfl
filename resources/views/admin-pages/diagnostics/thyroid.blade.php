<x-app-layout>
    <div class="bg-white dark:bg-gray-800 relative overflow-x-auto shadow-md sm:rounded-lg">
        <form class="mx-2 my-2">
            ...
            <h4 class="text-center text-2xl font-bold dark:text-white mx-auto">THYROID FUNCTION TESTS</h1>
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                        <td class="px-6 py-2 border-x">TSH</td>
                        <td class="px-6 py-2 border-x"></td>
                        <td class="px-6 py-2 border-x">0.3-4.2</td>
                        <td class="px-6 py-2 border-x">mIU/L</td>
                    </tr>
                    <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                        <td class="px-6 py-2 border-x">FT4</td>
                        <td class="px-6 py-2 border-x"></td>
                        <td class="px-6 py-2 border-x">12-22</td>
                        <td class="px-6 py-2 border-x">pmol/L</td>
                    </tr>
                    <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                        <td class="px-6 py-2 border-x">FT3</td>
                        <td class="px-6 py-2 border-x"></td>
                        <td class="px-6 py-2 border-x">2.8-7.1</td>
                        <td class="px-6 py-2 border-x">pmol/L</td>
                    </tr>
                    <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                        <td class="px-6 py-2 border-x">T3</td>
                        <td class="px-6 py-2 border-x"></td>
                        <td class="px-6 py-2 border-x">1.23-3.07</td>
                        <td class="px-6 py-2 border-x">nmol/L</td>
                    </tr>
                    <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                        <td class="px-6 py-2 border-x">T4</td>
                        <td class="px-6 py-2 border-x"></td>
                        <td class="px-6 py-2 border-x">66-181</td>
                        <td class="px-6 py-2 border-x">nmol/L</td>
                    </tr>
                </table>
            </div>
