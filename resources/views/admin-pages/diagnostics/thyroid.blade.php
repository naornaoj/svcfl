<x-app-layout>
    ...
    <div class="mb-2 bg-white dark:bg-gray-800 relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="mx-2 my-2">
            ...
            <div class="grid md:grid-cols-12 md:gap-4 ">
                ...
                <div class="relative z-0 mb-5 group col-span-3">
                    <label for="dateTimeRequested" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">DATE & TIME PERFORMED</label>
                    <input type="datetime-local" id="dateTimePerf" name="dateTimePerf" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" enabled />
                </div>
            </div>
        </div>
    </div>
    <div class="bg-white dark:bg-gray-800 relative overflow-x-auto shadow-md sm:rounded-lg">
        <form class="mx-2 my-2">
            <h4 class="text-center text-2xl font-bold dark:text-white mx-auto">THYROID FUNCTION TESTS</h4>
            <div class="grid md:gap-4 grid-cols-4 grid-rows-3 mb-5">
                <label for="TSH" class="text-gray-900 text-L rounded-lg focus:ring-blue-500 w-full p-2.5 dark:placeholder-gray-400 dark:text-white">TSH</label>
                <input type="text" id="TSH" name="TSH" class="text-right bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="mIU/L" required />
                <label for="FT4" class="text-gray-900 text-L rounded-lg focus:ring-blue-500 w-full p-2.5 dark:placeholder-gray-400 dark:text-white">FT4</label>
                <input type="text" id="FT4" name="FT4" class="text-right bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="pmol/L" required />
                <label for="FT3" class="text-gray-900 text-L rounded-lg focus:ring-blue-500 w-full p-2.5 dark:placeholder-gray-400 dark:text-white">FT3</label>
                ...
                <label for="T3" class="text-gray-900 text-L rounded-lg focus:ring-blue-500 w-full p-2.5 dark:placeholder-gray-400 dark:text-white">T3</label>
                <input type="text" id="T3" name="T3" class="text-right bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="nmol/L" required />
                <label for="T4" class="text-gray-900 text-L rounded-lg focus:ring-blue-500 w-full p-2.5 dark:placeholder-gray-400 dark:text-white">RESULT</label>
