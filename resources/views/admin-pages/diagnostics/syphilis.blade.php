        ...
        <form class="mx-2 my-2">
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <tr>
                        <td class="border text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 px-6 py-2 border">RESULT</td>
                        <td class="bg-white border dark:bg-gray-800 dark:border-gray-700 px-6 py-2 border"></td>
                    </tr>
                </table>
            </div>
        </form> -->
