            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">Consistency</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">Pus Cells</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">Amoeba</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">E.Coli</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">E.Histolyca</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">Ascaris</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>  
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">Hookworm</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr> 
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">Whip worm</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">Pinworm</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>  
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">Yeast Cells</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>  
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td class="px-6 py-2 border-x">Gardia lamblia</td>
                            <td class="px-6 py-2 border-x"></td>
                        </tr>  
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <tr class="bg-white border dark:bg-gray-800 dark:border-gray-700">
                            <td colspan="4" class="px-6 py-2 border-x">Remarks:</td>
                        </tr> 
                    </tbody>
                </table>
            </div>
