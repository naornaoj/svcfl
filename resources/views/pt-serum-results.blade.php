<x-client-layout>
    <div class="container">
        <form class="row g-3 needs-validation" novalidate method="GET" action="{{ route('pt-serum-results') }}">
            @csrf
            ...
            <h1 class="text-center font-bold text-xl mt-4" >Pregnancy test (SERUM)</h1>
