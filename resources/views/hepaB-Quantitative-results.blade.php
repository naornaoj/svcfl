<x-client-layout>
    <div class="container">
        <form class="row g-3 needs-validation" novalidate method="GET" action="{{ route('hepaB-Quantitative-results') }}">
            @csrf
            ...
            <h1 class="text-center font-bold text-xl mt-4" >Hepa B Surface Antigen Antibody (HBsAg)</h1>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">COI(CUTOFFINDEX) VALUE</th>
                        </tr>
                    </thead>
                    <tr>
                        <td class="col-3">FIA (FLOURESENCE IMMUNOASSAY)</td>
                        <td class="col-3">Hepa B Surface Antibody</td>
                        <td class="col-3"></td>
                        <td class="col-3"></td>
                </table>
